...
class UserStatusEntity(id: EntityID<Int>) : Entity<Int>(id) {
    companion object : EntityClass<Int, UserStatusEntity>(UserStatus) {
        override fun createInstance(entityId: EntityID<Int>, row: ResultRow?) = UserStatusEntity(entityId)
    }
